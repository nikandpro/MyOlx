...
public class DatabaseConfiguration {
    ...
    public static Dao<CategoiesProduct, Integer> catProdDao;
    ...
    static {
        try {
            ...
            TableUtils.createTableIfNotExists(connectionSource, CategoiesProduct.class);
            ...
            catProdDao = DaoManager.createDao(connectionSource, CategoiesProduct.class);
